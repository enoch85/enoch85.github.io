...
export default function Experience() {
  const experiences: ExperienceItemProps[] = [
    ...
    },
    {
      ...
      description: 'Grundade och drev IT-konsultbolag specialiserat på open source-infrastruktur och automation. Maintainer för Nextclouds officiella VM (100+ nedladdningar/dag globalt). Utvecklade automatiserade deployment-lösningar för flera virtualiseringsplattformar. Supporterade kunder över hela världen. Sålde bolaget till Kafit AB 2021 och fortsatte som CTO under transition.',
